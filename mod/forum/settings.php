...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configcheckbox('forum_enableanonymousposts', get_string('forum:anonymouspost', 'lae'),
                       get_string('forum:configenableanonymouspost', 'lae'), 0));
}
