...
(function() {
    ...
    function addScrollerDivs(tid,noOfCols) {
        ...
        $("#user-grades:scroller:fxcol > input").tabIndex=-1;
    }
//        }
//    }
    ...
    this.fxheader = function() {
        ...
        for(var i=0;i<tbl.length;i++) {
            ...
            t.id=tbl[i].tid+'__cN';
            // these lines appear to want to place a sizeable geological fault at the header where everything almost right of the static columns moves up 20 px
//            if(document.all) {
...
// this line seems to split the table and make the scrollable portion go below the rest of the table
