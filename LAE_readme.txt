===Moodle 1.9.18+Liberal Arts Edition v1.7 Release Notes===

Welcome to the Moodle 1.9.18+Liberal Arts Edition v1.7. The goal of LAE is to provide a coherent package for modules, patches, and code developed (or improved) by the Collaborative Liberal Arts Moodle Project. 
...
===CONTENTS===
Moodle 1.9.18+LAEv1.7 consists of Moodle 1.9.18 (20120514) as well as a number of CLAMP-developed features and bug fixes. 
...
git clone ssh://<username>@mitre.clamp-it.org/home/git/moodle v1.9.16-LAE1.6.2
git checkout -b v1.9.18-LAE1.8
