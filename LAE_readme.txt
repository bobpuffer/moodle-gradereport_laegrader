===Moodle 1.9.19+Liberal Arts Edition v1.7.1 Release Notes===

Welcome to the Moodle 1.9.19+Liberal Arts Edition v1.7.1. The goal of LAE is to provide a coherent package for modules, patches, and code developed (or improved) by the Collaborative Liberal Arts Moodle Project. 
...
===CONTENTS===
Moodle 1.9.19+LAEv1.7.1 consists of Moodle 1.9.19 (20120706) as well as a number of CLAMP-developed features and bug fixes. 
...
git clone ssh://<username>@mitre.clamp-it.org/home/git/moodle v1.9.19-LAE1.7.1
git checkout -b v1.9.19-LAE1.7.1
