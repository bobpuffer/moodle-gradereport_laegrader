===Moodle 2.3.3+Liberal Arts Edition v3.0.3 Release Notes===

Welcome to the Moodle 2.3.3+Liberal Arts Edition v3.0.3. The goal of LAE is to provide a coherent package for modules, patches, and code developed (or improved) by the Collaborative Liberal Arts Moodle Project. 
...
===CONTENTS===
Moodle 2.3.3+LAEv3.0.3 consists of Moodle 2.3.3 (20121112) as well as a number of CLAMP-developed features and bug fixes. 
...
git clone ssh://<username>@mitre.clamp-it.org/home/git/moodle v2.3.3-LAE3.0.3
git checkout -b v2.3.3-LAE3.0.3
