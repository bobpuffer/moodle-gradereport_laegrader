===Moodle 2.2.10+Liberal Arts Edition v2.2.8 Release Notes===

Welcome to the Moodle 2.2.10+Liberal Arts Edition v2.2.8. The goal of LAE is to provide a coherent package for modules, patches, and code developed (or improved) by the Collaborative Liberal Arts Moodle Project. 
...
===CONTENTS===
Moodle 2.2.10+LAEv2.2.8 consists of Moodle 2.2.10 (20111205) as well as a number of CLAMP-developed features and bug fixes. 
...
git clone ssh://<username>@mitre.clamp-it.org/home/git/moodle v2.2.10-LAE2.2.8
git checkout -b v2.2.10-LAE2.2.8
