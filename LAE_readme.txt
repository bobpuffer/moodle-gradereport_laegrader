===Moodle 2.2.6+Liberal Arts Edition v2.2.5 Release Notes===

Welcome to the Moodle 2.2.6+Liberal Arts Edition v2.2.5. The goal of LAE is to provide a coherent package for modules, patches, and code developed (or improved) by the Collaborative Liberal Arts Moodle Project. 
...
===CONTENTS===
Moodle 2.2.6+LAEv2.2.5 consists of Moodle 2.2.6 (20121112) as well as a number of CLAMP-developed features and bug fixes. 
...
v2.2.5 includes a backported core fix from 2.3.4:
...
git clone ssh://<username>@mitre.clamp-it.org/home/git/moodle v2.2.6-LAE2.2.5
git checkout -b v2.2.6-LAE2.2.5
