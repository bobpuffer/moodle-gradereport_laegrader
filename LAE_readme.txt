===Moodle 2.3.4+Liberal Arts Edition v3.0.5 Release Notes===

Welcome to the Moodle 2.3.4+Liberal Arts Edition v3.0.5. The goal of LAE is to provide a coherent package for modules, patches, and code developed (or improved) by the Collaborative Liberal Arts Moodle Project. 
...
===CONTENTS===
Moodle 2.3.4+LAEv3.0.5 consists of Moodle 2.3.4 (20130114) as well as a number of CLAMP-developed features and bug fixes. 
...
git clone ssh://<username>@mitre.clamp-it.org/home/git/moodle v2.3.4-LAE3.0.5
git checkout -b v2.3.4-LAE3.0.5
