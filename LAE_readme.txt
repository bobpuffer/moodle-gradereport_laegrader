===Moodle 2.2.9+Liberal Arts Edition v2.2.7 Release Notes===

Welcome to the Moodle 2.2.9+Liberal Arts Edition v2.2.7. The goal of LAE is to provide a coherent package for modules, patches, and code developed (or improved) by the Collaborative Liberal Arts Moodle Project. 
...
===CONTENTS===
Moodle 2.2.9+LAEv2.2.7 consists of Moodle 2.2.9 (20130318) as well as a number of CLAMP-developed features and bug fixes. 
...
git clone ssh://<username>@mitre.clamp-it.org/home/git/moodle v2.2.9-LAE2.2.7
git checkout -b v2.2.9-LAE2.2.7
