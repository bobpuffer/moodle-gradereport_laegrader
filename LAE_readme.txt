===Moodle 2.3.2+Liberal Arts Edition v3.0.2 Release Notes===

Welcome to the Moodle 2.3.2+Liberal Arts Edition v3.0.2. The goal of LAE is to provide a coherent package for modules, patches, and code developed (or improved) by the Collaborative Liberal Arts Moodle Project. 
...
===CONTENTS===
Moodle 2.3.2+LAEv3.0.2 consists of Moodle 2.3.2 (20120910) as well as a number of CLAMP-developed features and bug fixes. 
...
The following bug fixes (with their CLAMP tracking number) were included in v3.0.2:

* CLAMP-447: Updated OU Dates Report
* CLAMP-450: Upgrade support for Quickmail
* CLAMP-454: Create groups fails when auto-groupings feature active
* CLAMP-452: LAE Grader Report: Grade Item Edits Set Totals to Overridden without Calculating Changes
...
git clone ssh://<username>@mitre.clamp-it.org/home/git/moodle v2.3.2-LAE3.0.2
git checkout -b v2.3.2-LAE3.0.2
