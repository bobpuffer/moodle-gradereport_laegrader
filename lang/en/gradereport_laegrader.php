...
$string['extracols'] = 'Show extra user columns';
$string['extracols_help'] = 'Show extra user columns (such as user email or user idnumber -- as set in user policies) in the grader report';
