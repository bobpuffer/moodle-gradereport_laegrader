...
$string['extrafields'] = 'Show extra user fields';
$string['extrafields_help'] = 'Show extra user fields (such as user email or user idnumber -- as set in user policies) in the grader report';
