...
$string['attachmenterror'] = 'Pièce jointe non valide!  Le fichier: <strong>$a</strong> n\'existe pas';
$string['blockname'] = 'Quickmail';
$string['check'] = 'Tout sélectionner';
...
$string['deletesuccess'] = 'Suppression(s) réussie(s)';
...
$string['noemailssent'] = 'Aucune courriel envoyé';
$string['sendemail'] = 'Envoyez Courriel';
$string['subjecterror'] = 'Sujet obligatoire!';
$string['successfulemail'] = 'Envoi Courriel(s) réussi!';
$string['to'] = 'A';
$string['toerror'] = 'Destinataire(s) obligatoire!';
$string['uncheck'] = 'Tout déselectionner';
