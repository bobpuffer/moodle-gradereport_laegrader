...
*/
    ...
    $settings->add(new admin_setting_configcheckbox('grade_report_laegrader_extracols', get_string('extracols', 'gradereport_laegrader'), get_string('extracols_help', 'gradereport_laegrader'), 0));
}
